package com.example.shouhei.wander;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng home = new LatLng(49.231905, -122.997505);
        float zoom = 15;
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(home, zoom));
        setMapLongClick(mMap);
        setPoiClick(mMap);

        // Set an OnInfoWindowClickListener to replace street view
    ...
    public void onRequestPermissionsResult(
        ...
        // Check if location permission are granted and if so enable the
        // location data layer.
        switch (requestCode) {
